...
class GeometrySerializer(_object):
    ...
    def read(self, *args):
        """
        read(GeometrySerializer self, file f, std::string const & guid, unsigned int representation_id, GeometrySerializer::read_type rt) -> Element
        read(GeometrySerializer self, file f, std::string const & guid, unsigned int representation_id) -> Element
        """
...
class WriteOnlyGeometrySerializer(GeometrySerializer):
    ...
    def read(self, *args):
        """
        read(WriteOnlyGeometrySerializer self, file arg2, std::string const & arg3, unsigned int arg4, GeometrySerializer::read_type arg5) -> Element
        read(WriteOnlyGeometrySerializer self, file arg2, std::string const & arg3, unsigned int arg4) -> Element
        """
...
class HdfSerializer(GeometrySerializer):
    ...
    def __init__(self, hdf_filename, settings):
        """__init__(HdfSerializer self, std::string const & hdf_filename, SerializerSettings settings) -> HdfSerializer"""
        this = _ifcopenshell_wrapper.new_HdfSerializer(hdf_filename, settings)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def read(self, *args):
        """
        read(HdfSerializer self, file f, std::string const & guid, unsigned int representation_id, GeometrySerializer::read_type rt) -> Element
        read(HdfSerializer self, file f, std::string const & guid, unsigned int representation_id) -> Element
        """
